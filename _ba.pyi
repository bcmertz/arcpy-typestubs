...
def ListDatasets() -> Generator[Incomplete, None, None]: ...
def ListVariables(dataset, include_derivatives: bool = False) -> Generator[Incomplete, None, None]: ...
def ListGeographyLevels(dataset) -> Generator[Incomplete, None, None]: ...
