...
class CountryInfo:
    ...
    ISO3: Incomplete
    Name: Incomplete
    def __init__(self, name=None, iso2=None, iso3=None) -> None: ...
...
class Dataset:
    ...
    Version: Incomplete
    def __init__(self, id, countryName, countryIso2, countryIso3, vintage, directory=None, installDirectory=None, networkDatasetPath=None, hasMoe=None) -> None: ...
