...
class _Timezone(_ParameterChecker):
    ...
    def __init__(self, ID=None, DaylightSavingTime=None, preferredTimezoneID=None, preferredTimezoneIDDaylightSavingTime=None) -> None: ...
...
class _Cache(_ParameterChecker):
    ...
    def __init__(self, configuration: str = '', exportTiles: bool = False, exportTilesCount: int = 100000, cacheOnDemand=None, useExistingCache=None) -> None: ...
