...
class Extent(mixins.ExtentMixin, _BaseArcObject):
    ...
    polygon: Incomplete
    JSON: Incomplete
    def contains(self, second_geometry, relation: Incomplete | None = None): ...
    ...
    def within(self, second_geometry, relation: Incomplete | None = None): ...
    def projectAs(self, spatial_reference, transformation_name: Incomplete | None = None): ...
...
class Geometry(mixins.GeometrySpecializationMixin, _BaseArcObject):
    ...
    def __getSVG__(self, scale_factor: float = 1.0, color: Incomplete | None = None): ...
    ...
    def getLength(self, method: str = 'GEODESIC', units: Incomplete | None = None): ...
    def getArea(self, method: str = 'GEODESIC', units: Incomplete | None = None): ...
    ...
    def cut(self, other): ...
    def densify(self, method, distance: int = 0, deviation: Incomplete | None = None): ...
    def move(self, dx: float = 0.0, dy: float = 0.0, dz: Incomplete | None = None): ...
    def scale(self, origin: Incomplete | None = None, sx: float = 1.0, sy: float = 1.0, sz: Incomplete | None = None): ...
    def rotate(self, origin: Incomplete | None = None, rotation_angle: float = 0.0): ...
...
class Result(mixins.ResultMixin, _BaseArcObject):
    ...
    def getMessage(self, *args): ...
    def getMessages(self, *args): ...
    def getCharts(self, wildcard: Incomplete | None = None): ...
    def getAllMessages(self, *args): ...
    def getSeverity(self, *args): ...
