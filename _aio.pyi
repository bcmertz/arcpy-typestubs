...
class _LocalScandirIterator:
    def __init__(self, dir_entry=None) -> None: ...
    def __iter__(self): ...
    def __next__(self): ...

class _CloudScandirIterator:
    def __init__(self, dir_entry=None, type=None) -> None: ...
    def __iter__(self): ...
    def __next__(self): ...
...
class AIOScandirIterator:
    ...
    @classmethod
    def new(cls, dir_entry, is_cloud: bool = False, type=None): ...
    def __iter__(self): ...
    def __next__(self): ...
...
class CloudOp:
    ...
    def validate(self, certificate: bool = False, stat: bool = False, list: bool = False, read: bool = False, modify: bool = False, path=None): ...
...
class _LocalIO:
    ...
    def scandir(self, path, depth=None, type=None, prefix=None): ...
...
class _CloudIO:
    ...
    def isdir(self, path): ...
    def isfile(self, path): ...
    def listdir(self, path=None, type=...): ...
    def mkdir(self, path) -> None: ...
    def makedirs(self, path) -> None: ...
    def open(self, path, mode=None, encoding=None, mime=None): ...
    def remove(self, path) -> None: ...
    def removefiles(self, paths=None): ...
    def rename(self, src=None, dst=None) -> None: ...
    def rmtree(self, path) -> None: ...
    def scandir(self, path, depth: int = 0, type=..., prefix=None): ...
...
class AIO:
    ...
    def mkdir(self, path): ...
    def makedirs(self, path): ...
    def open(self, path, mode=None, encoding: str = 'utf-8', mime=None): ...
    def remove(self, path): ...
    def removefiles(self, paths=None): ...
    def rename(self, src=None, dst=None): ...
    def rmtree(self, path): ...
...
def AIOFileOpen(path, mode: str = 'r', encoding: str = 'utf-8', mime=None): ...
