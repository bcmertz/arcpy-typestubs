...
class CIMFloodSimulationWaterObject(CIMFloodSimulationObject):
    waterFlowRate: Incomplete
    waterRateTransitionTime: int
    def __init__(self, *args, **Kwargs) -> None: ...

class CIMFloodSimulationWaterSinkArea(CIMFloodSimulationWaterObject):
    area: Incomplete
    maximumIntake: int
    def __init__(self, *args, **Kwargs) -> None: ...

class CIMFloodSimulationWaterSource(CIMFloodSimulationWaterObject):
    location: Incomplete
    def __init__(self, *args, **Kwargs) -> None: ...

class CIMFloodSimulationWaterSourceArea(CIMFloodSimulationWaterObject):
    area: Incomplete
    def __init__(self, *args, **Kwargs) -> None: ...
